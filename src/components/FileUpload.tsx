...
export const FileUpload = () => {
    ...
    const [
        ...
        { handleDragEnter, handleDragLeave, handleDragOver, handleDrop, removeFile, clearFiles, getInputProps },
    ] = useFileUpload({
        ...
        <div className="flex flex-col gap-2">
            ...
            {files.length > 0 && (
                <div className="space-y-2">
                    ...
                    {files.length > 1 && (
                        <div>
                            <Button onClick={clearFiles}>Remove all files</Button>
                        </div>
                    )}
                </div>
            )}

            <p aria-live="polite" className="mt-2 text-center text-muted-foreground text-xs" role="region">
