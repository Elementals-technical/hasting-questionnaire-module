        ...
        return (
          <fieldset className={clsx(s.fieldset, className)}>
            ...
            <RadioGroup.Root
              ...
              onBlur={field.onBlur}
              className={clsx(s.group, orientation === "horizontal" ? s.horizontal : s.vertical, error && s.groupError)}
            ...
            >
              {options.map((opt, i) => {
                ...
                const Icon = opt.icon;
                return (
                  <div key={opt.value} className={clsx(s.option, { [s.active]: opt.value === field.value })}>
                    <RadioGroup.Item id={id} className={s.radio} value={opt.value} disabled={opt.disabled}>
                      <div
                        className={clsx(
                          s.radioItem,
